              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    <h1>Hi ${Name},</h1>
                    <p>You recently requested to reset your password for your Donum account. Click the button below to reset it.</p>
                    <!-- Action -->
                    <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center">
                          <div>
                            <a href=${ResetURL} class="button button--red">Reset your password</a>
                          </div>
                        </td>
                      </tr>
                    </table>
