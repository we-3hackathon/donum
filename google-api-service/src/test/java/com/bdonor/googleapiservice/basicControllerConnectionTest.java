...
public class basicControllerConnectionTest {
    ...
    @Test
    public void testMapController() throws Exception {
        this.mockMvc.perform(get("/map/test")).andDo(print()).andExpect(status().isOk())
                .andExpect(content().string(containsString("MapController")));
    }
}
